...
import com.mubly.comewaves.model.model.YwpAddressBean;
...
/**
 * Created by mubly on 2018/10/10
 * 自定义仿京东地址选择器
 */

public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    // recyclerView 选中Item 的颜色
    private int defaultSelectedColor = Color.parseColor("#000000");
    ...
    // 确定字体可以点击时候的颜色//FED846
    private int defaultSureCanClickColor = Color.parseColor("#000000");
    ...
    class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.selectIv.setVisibility(GONE);
            // 设置选中效果的颜色
            switch (tabSelectPosition) {
                case 0:
                    if (mRvData.get(position) != null &&
                        ...
                        holder.selectIv.setVisibility(VISIBLE);
                    }
                    break;
                case 1:
                    if (mRvData.get(position) != null &&
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View itemView) {
                ...
                selectIv=itemView.findViewById(R.id.item_select_iv);
            }
