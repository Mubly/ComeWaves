...
import com.mubly.comewaves.model.adapter.AGVBaseAdapter;
import com.mubly.comewaves.view.interfaceview.AsymmetricView;
...
public final class AdapterImpl implements View.OnClickListener, View.OnLongClickListener {
  ...
  public AdapterImpl(Context context, AGVBaseAdapter<?> agvAdapter, AsymmetricView listView) {
 ...
 public int getRowCount() {
  ...
  public void onBindViewHolder(ViewHolder holder, int position, ViewGroup parent) {
    if (debugEnabled) {
